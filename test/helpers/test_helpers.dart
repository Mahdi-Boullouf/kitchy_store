...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<OrdersService>(onMissingStub: OnMissingStub.returnDefault),
...
MockOrdersService getAndRegisterOrdersService() {
  _removeRegistrationIfExists<OrdersService>();
  final service = MockOrdersService();
  locator.registerSingleton<OrdersService>(service);
  return service;
}
